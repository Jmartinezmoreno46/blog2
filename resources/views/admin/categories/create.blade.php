...
@section('content')
    {{-- hacemos uso de laravel collectiv , si no esta descargado instalalo en la terminal con 
    composer require laravelcollective/html --}}

    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.categories.store']) !!}  {{-- utilizamos el formulario collective de la siguiente manera Form::open --}}
